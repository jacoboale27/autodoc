...
class PdfGenerator {
  static Future<void> generateServiceHistoryPdf(
    ...
    List<ServiceRecordModel> services,
  ...
  static pw.Widget _buildHeader(VehicleModel vehicle, AppLocalizations l10n) {
    return pw.Column(
      ...
      children: [
        ...
        pw.Text(
          l10n.pdfReportDate(DateFormat('dd/MM/yyyy').format(DateTime.now())),
        ),
        pw.Divider(),
      ],
    );
  ...
  static pw.Widget _buildSummary(
    ...
    final double totalGasto = services.fold(
      0,
      (sum, item) => sum + (item.costo ?? 0.0),
    );
    return pw.Row(
      ...
      children: [
        ...
        pw.Text(
          l10n.pdfTotalSpent(totalGasto.toStringAsFixed(2)),
