  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SafeArea(
          // Tema, idioma y campana también aquí (observaciones del
          // 2026-09-19): esta pantalla no tiene barra superior, así que van
          // en la esquina.
          child: Stack(
            fit: StackFit.expand,
            children: [
              ...
              const Positioned(top: 0, right: 0, child: AccionesDeCabecera()),
            ],
          ),
        ),
      ),
