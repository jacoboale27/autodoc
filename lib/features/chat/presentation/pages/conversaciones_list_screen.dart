          ...
          : chatProvider.conversaciones.isEmpty
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final noLeidos = isMecanico ? conv.noLeidosMecanico : conv.noLeidosPropietario;
                    
                    // Por ahora usamos nombres genéricos
                    final targetName = isMecanico ? conv.nombrePropietario : conv.nombreMecanico;

                    return ListTile(
                      onTap: () {
                        if (noLeidos > 0) {
                          chatProvider.marcarComoLeidos(conv.id, isMecanico, userSession.user?.uid ?? '');
                        }
