...
class ReservaDetailScreen extends StatefulWidget {
  ...
  const ReservaDetailScreen({super.key, required this.reservaId});
...
class _ReservaDetailScreenState extends State<ReservaDetailScreen> {
  ...
  Future<void> _cambiarEstado(String nuevoEstado) async {
    ...
    try {
      ...
      if (mounted) {
        UiUtils.showErrorSnackbar(context, context.l10n.adminError(e.toString()));
      }
    } finally {
      ...
      builder: (ctx) => CotizacionPicker(
        ...
        onConfirm: (items, fechaPropuesta) async {
          final cotizacion = CotizacionModel(
            ...
            idMecanico: userId,
            idVehiculo: reserva.idVehiculo.isNotEmpty ? reserva.idVehiculo : null,
            idTaller: userId,
            items: items,
