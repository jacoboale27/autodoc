...
void main() {
  testWidgets('la lista de empleados muestra el rol de cada empleado seedeado', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      MultiProvider(
        ...
        child: MaterialApp.router(
          ...
          // Sin los delegados, `AppLocalizations.of(context)` devuelve null y
          // `context.l10n` revienta con "Null check operator used on a null
          // value" en cuanto un widget del arbol traduce algo. Lo destapo la
          // traduccion del titulo del panel del taller: MechanicSidebar paso
          // a usar context.l10n y estos tests montaban un MaterialApp sin
          // localizacion, o sea menos parecido a la app real de lo que creian.
